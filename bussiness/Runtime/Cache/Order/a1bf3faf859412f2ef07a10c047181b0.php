    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Order/Index/recycleorder');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-retweet"></span>已回收</button></a> 
        </div>
      </div>
        <div class="col-xs-12">
          <div class="box">
