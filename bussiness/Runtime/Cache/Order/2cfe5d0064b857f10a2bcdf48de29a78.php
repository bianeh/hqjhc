  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Orders/Index/index');?>">发货信息添加</a></li>
        <li class="active">添加发货信息</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <!-- <h3 class="box-title">管理员添加</h3> -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addDeliveryinfo" method="post"  action="<?php echo U('Order/Index/doAdddeleveryinfo');?>">
                <!-- text input -->
                ...
                <div class="form-group">
                  <label>物流单号</label>
                  <input type="text" id="loginPwd" name="expressNo" class="form-control" placeholder="物流单号">
                </div>
                <input type="hidden" name="orderNo" value="<?php echo ($orderno); ?>" />
              </form>
                <div class="form-group">
                    <button id="adddeliverinfoOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
 ...
 <script>
    var adddeliverinfoOperate = document.getElementById("adddeliverinfoOperate");
    adddeliverinfoOperate.onclick=function()
    {     
          document.getElementById("addDeliveryinfo").submit();
    }
  </script>