    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Order/Index/waitexpress');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-shopping-cart"></span>待发货</button></a>
           ...
           <a href="<?php echo U('Order/Index/canceledorder');?>"><button type="button" class="btn bg-default btn-flat margin"><span class="glyphicon glyphicon-remove-sign"></span>已取消</button></a> 
...
<!--                  <td>订单状态</td>-->
                  <td>
                      <button value="<?php echo ($vo["orderno"]); ?>" class="btn bg-olive btn-flat margin checkaction">
                          <i class="fa fa-fw fa-check-circle"></i>确认订单
                      </button>
...
<script>
  $(function () {
    ...
    $(".checkaction").click(function(){
      var r = confirm("确定要确认该产品信息吗");
      var orderno = $(this).val();
      if(r)
      {
         window.location.href="<?php echo U('Order/Index/checkorder/orderno/"+orderno+"');?>";
      }
    });
    $(".cancelaction").click(function(){
      var r = confirm("确定要取消该产品信息吗");
      var orderno = $(this).val();
      if(r)
      {
         window.location.href="<?php echo U('Order/Index/cancelorder/orderno/"+orderno+"');?>";
      }
    });
  })
</script>