    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Order/Index/checkedorder');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-ban-circle"></span>拣货中</button></a>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                      <a href="<?php echo U('Order/Index/adddeliveryinfo');?>?orderno=<?php echo ($vo["orderno"]); ?>">
                      <button class="btn bg-olive btn-flat margin">
                          <i class="fa fa-fw fa-check-circle"></i>确认发货
                      </button>
                      </a>
