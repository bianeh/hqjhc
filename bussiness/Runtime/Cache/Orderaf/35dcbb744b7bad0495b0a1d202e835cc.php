    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Orderaf/Index/returngoods');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-shopping-cart"></span>退货</button></a>
        </div>
      </div>
        <div class="col-xs-12">
          <div class="box">
...
<!--                <tr>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                       <?php if($vo['returngoods_status'] == 0): ?>待处理<?php endif; ?>
                      ...
                      <?php if($vo['returngoods_status'] == 4): ?>不通过<?php endif; ?>
                  </td>
...
<!--                  <td>
                  ...
                  <td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo U('Orderaf/Index/checkreturnsuccess',['id'=>$vo['id']]);?>">审核通过</a></li>
                        <li><a href="<?php echo U('Orderaf/Index/checkreturnfail',['id'=>$vo['id']]);?>">审核不通过</a></li>
                        <li><a href="<?php echo U('Orderaf/Index/returned',['id'=>$vo['id']]);?>">已退货</a></li>
                        <li><a href="<?php echo U('Orderaf/Index/returnapplyclose',['id'=>$vo['id']]);?>">关闭</a></li>
                      </ul>
                      </div>
                  </td>
<!--                  <td>
