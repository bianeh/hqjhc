  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Order/Index/index');?>">退货退款管理</a></li>
    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Orderaf/Index/index');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-question-sign"></span>全部</button></a>
           <a href="<?php echo U('Orderaf/Index/leakgoods');?>"><button type="button" class="btn bg-default btn-flat margin"><span class="glyphicon glyphicon-ok-sign"></span>漏货</button></a>
           <a href="<?php echo U('Orderaf/Index/lackgoods');?>"><button type="button" class="btn bg-default btn-flat margin"><span class="glyphicon glyphicon-shopping-cart"></span>缺货</button></a>
           <a href="<?php echo U('Orderaf/Index/returngoods');?>"><button type="button" class="btn bg-default btn-flat margin"><span class="glyphicon glyphicon-ban-circle"></span>退货</button></a>
        </div>
      </div>                    
        <div class="col-xs-12">
          <div class="box">
...
<!--                <tr>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                    <?php if($vo['type'] == 1): ?>平台漏发<?php endif; ?>
                    <?php if($vo['type'] == 2): ?>平台缺货<?php endif; ?>
                    <?php if($vo['type'] == 3): ?>退货<?php endif; ?>
                  </td>
                  <td>
                  <?php if($vo['type'] == 1): if($vo['leakage_status'] == 0): ?>待处理<?php endif; ?>
                      <?php if($vo['leakage_status'] == 1): ?>处理中<?php endif; ?>
                      <?php if($vo['leakage_status'] == 2): ?>已关闭<?php endif; endif; ?>
                  <?php if($vo['type'] == 2): if($vo['lack_status'] == 0): ?>待处理<?php endif; ?>
                      <?php if($vo['lack_status'] == 1): ?>处理中<?php endif; ?>
                      <?php if($vo['lack_status'] == 2): ?>已关闭<?php endif; endif; ?>
                  <?php if($vo['type'] == 3): if($vo['returngoods_status'] == 0): ?>待处理<?php endif; ?>
                      <?php if($vo['returngoods_status'] == 1): ?>处理中<?php endif; ?>
                      <?php if($vo['returngoods_status'] == 2): ?>已退货<?php endif; ?>
                      <?php if($vo['returngoods_status'] == 3): ?>已关闭<?php endif; ?>
                      <?php if($vo['returngoods_status'] == 4): ?>不通过<?php endif; endif; ?>
                  </td>
                  <td>
                      <a target="_blank" href="<?php echo U('Order/Index/orderinfo',['id'=>$vo['orderid']]);?>">
...
<!--                  <td>
                      ...
                      <button value="<?php echo ($vo["id"]); ?>" class="btn bg-maroon btn-flat margin delete">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo U('Product/Index/checkacross',['id'=>$vo['id']]);?>">审核通过</a></li>
                        <li><a href="<?php echo U('Product/Index/checkfail',['id'=>$vo['id']]);?>">审核不通过</a></li>
                      </ul>
                      </div>
                  </td>-->
                  </tr>
<!--                  <tr>
                      <td>
                        <?php if($vo['useraddress'] != ''): echo ($vo["useraddress"]); endif; ?>
                  </td>
