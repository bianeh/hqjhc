                  ...
                  <td><?php echo ($vo["createstaffname"]); ?></td>
                   <td>
                      ...
                      <button class="btn bg-olive btn-flat margin">
                       ...
                       <button value="<?php echo ($vo["id"]); ?>" class="btn btn-info btn-flat margin submitchek">
                          <i class="fa fa-fw fa-check-circle"></i>提交审核
                      </button>
...
<script>
  $(function () {
    ...
    $(".delete").click(function(){
     ...
     $(".submitchek").click(function(){
      var r = confirm("确定要提交该产品审核吗");
      var id = $(this).val();
      if(r)
      {
         window.location.href="<?php echo U('Product/Index/submitcheck/id/"+id+"');?>";
      }
    });
  })
</script>