...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-12">
        <div class="search1">
<!--           <a href="<?php echo U('Admin/Index/addUserPage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加管理员</button></a>-->
           <a href="<?php echo U('Funds/Userslogsmoneys/getpay');?>"><button type="button" class="btn bg-purple margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["moneyid"]); ?></td>
                  <td><?php echo ($vo["orderno"]); ?></td>
                  <td><?php echo ($vo["username"]); ?></td>
                  <td><?php echo ($vo["amount"]); ?></td>
                  <td>
                    <?php if($vo['datasource'] == 4): ?>支付宝交易<?php endif; ?>
                    <?php if($vo['datasource'] == 5): ?>钱包交易<?php endif; ?>
                    <?php if($vo['datasource'] == 6): ?>微信交易<?php endif; ?>
                    <?php if($vo['datasource'] == 8): ?>微信购买vip<?php endif; ?>
                    <?php if($vo['datasource'] == 9): ?>支付宝购买vip<?php endif; ?>
                    <?php if($vo['datasource'] == 10): ?>钱包购买vip<?php endif; ?> 
                     <?php if($vo['datasource'] == 11): ?>支付宝批处理交易<?php endif; ?> 
                    <?php if($vo['datasource'] == 12): ?>钱包批处理交易<?php endif; ?>
                    <?php if($vo['datasource'] == 13): ?>微信批处理交易<?php endif; ?>
...
<script>
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      {
         var stffid = $(this).val();
         window.location.href="<?php echo U('Admin/Index/delete/stffid/"+stffid+"');?>";
      }
    });
  })
</script>