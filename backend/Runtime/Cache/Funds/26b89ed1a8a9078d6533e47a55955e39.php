...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Admin/Index/index');?>">手动充值</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="doRecharge" method="post"action="<?php echo U('Funds/Recharge/doRechargeUser');?>">
                <!-- text input -->
                ...
                <div class="form-group">
                  <label>充值金额</label>
                  <input type="text" id="staffNo" name="amount" class="form-control" placeholder="充值金额">
                </div>
                 <div class="form-group">
                  <label>备注</label>
                  <textarea class="form-control" name="remarks" placeholder="备注"></textarea>
                </div>
                <input type="hidden" name="note" value="<?php echo ($data["stffid"]); ?>"/>
              </form>
                <div class="form-group">
                    <button id="doRechargeOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>充值</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var doRechargeOperate = document.getElementById("doRechargeOperate");
    doRechargeOperate.onclick=function()
    {     
          
                       document.getElementById("doRecharge").submit();
