...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        微商账户收入明细列表
        <small>微商收入信息列表</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 后台</a></li>
        <li><a href="#"> 财务管理</a></li>
        <li class="active">微商账户收入明细管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
...
<!--           <a href="<?php echo U('Admin/Index/addUserPage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加管理员</button></a>-->
           <a href="<?php echo U('Funds/Userslogsmoneys/getentrance');?>"><button type="button" class="btn bg-purple margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                    <?php if($vo['datasource'] == 1): ?>支付宝充值<?php endif; ?>
                    <?php if($vo['datasource'] == 2): ?>微信充值<?php endif; ?>
                    <?php if($vo['datasource'] == 3): ?>后台手动充值<?php endif; ?> 
