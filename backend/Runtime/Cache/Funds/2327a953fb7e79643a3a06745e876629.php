...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        微商商品订单交易资金列表
        <small>微商商品订单交易资金列表</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 后台</a></li>
        <li><a href="#">微商商品订单交易资金管理</a></li>
        <li class="active">微商商品订单交易管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
    ...
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Funds/Ordersettlement/index');?>"><button type="button" class="btn bg-purple margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
...
<!--                  <th>微商用户</th>-->
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><?php echo ($vo["ordersettleid"]); ?></td>
                  <td><?php echo ($vo["orderno"]); ?></td>
<!--                  <td><?php echo ($vo["username"]); ?></td>-->
                  <td><?php echo ($vo["actualpaymoney"]); ?></td>
                  <td><?php echo ($vo["examount"]); ?></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td>
                    <?php if($vo['datasrc'] == 1): ?>支付宝订单交易<?php endif; ?>
                    <?php if($vo['datasrc'] == 2): ?>微信订单交易<?php endif; ?>
                    <?php if($vo['datasrc'] == 3): ?>钱包订单交易<?php endif; ?>
                    <?php if($vo['datasrc'] == 4): ?>支付宝购物车批量交易<?php endif; ?>
                    <?php if($vo['datasrc'] == 5): ?>微信购物车批量交易<?php endif; ?>
                    <?php if($vo['datasrc'] == 6): ?>钱包购物车批量交易<?php endif; ?>
                  </td>
                  <td>
                      <?php if($vo['status'] == 0): ?>失败<?php endif; ?>
