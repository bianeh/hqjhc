...
.loginform{position:absolute;height:400px;top: 20%;;width:419px;border:2px solid #00BCD4;z-index: 99999;right:20%;margin:0 auto;border-radius:5px;padding-top:30px;}
...
<div id="tab">
	...
	<div class="loginform">
	     <form action="<?php echo U('User/Login/dologin');?>" method="post">
		      <h1 style="text-align:center;">环球集货仓管理后台</h1>
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
                <input type="checkbox"> <span style="color:#666">记住我</span>
            </label>
          </div>
        </div>
         /.col 
