...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editGrade" method="post" action="<?php echo U('Grade/Index/doEditgrade');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>档期名称</label>
                  <input type="text"  name="gradeName" value="<?php echo ($info["gradename"]); ?>" class="form-control" placeholder="档期名称">
                </div>
                <div class="form-group">
                  <label>品牌名称</label>
                  <select multiple="" name="brandid" class="form-control">
                  <?php if(is_array($brandslist)): $i = 0; $__LIST__ = $brandslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo["brandid"]); ?>" <?php if($info['brandid'] == $vo['brandid']): ?>selected <?php else: endif; ?>><?php echo ($vo["brandname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>
                </div>
                <div class="form-group">
                <label>开始时间:</label>
                <div class="input-group date">
                  <div class="input-group-addon">
                   ...
                   <input readonly="readonly" name="startdate" id="test" value="<?php echo ($info["startdate"]); ?>" class="txt" style="width:400px;border-color:1px solid #d2d6de" type="text">
      <br />
      <input class="button" style="opacity: 0;position: absolute;top:0px;width: 400px"  type="button" id="selbtn" name="selbtn" value="时间" onclick="showCalendar('test', '%Y-%m-%d %H:%M', '24', false, 'selbtn');" />
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input readonly="readonly" name="enddate" id="test1" value="<?php echo ($info["enddate"]); ?>" class="txt" style="width:400px;border-color:1px solid #d2d6de" type="text">
      <br />
      <input style="opacity: 0;position: absolute;top:0px;width: 400px" class="button" type="button" id="selbtn1" name="selbtn1" value="时间" onclick="showCalendar('test1', '%Y-%m-%d %H:%M', '24', false, 'selbtn1');" />
              ...
              <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" />
                ...
                <div class="form-group">
                    <button id="editGradeOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-edit"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var editGradeOperate = document.getElementById("editGradeOperate");
    editGradeOperate.onclick=function()
    {     
