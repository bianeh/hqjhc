...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
   <script type="text/javascript">
    ...
    <script type="text/javascript" src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/datetimer/js/calendar.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo (ROOT_URL); ?>/Public/backend/plugins/datetimer/css/calendar.css" media="all" />
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Grade/Index/index');?>">档期管理</a></li>
        <li class="active">添加档期</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <input readonly="readonly" name="date" id="test" value="" class="txt" style="width:400px;" type="text">
      <br />
      <input class="button" type="button" id="selbtn" name="selbtn" value="时间" onclick="showCalendar('test', '%Y-%m-%d %H:%M', '24', false, 'selbtn');" />
    </div> -->  
              <form role="form" id="addGrade" method="post" action="<?php echo U('Grade/Index/doAddgrade');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>档期名称</label>
                  <input type="text"  name="gradeName" class="form-control" placeholder="档期名称">
                </div>
                <div class="form-group">
                  <label>品牌名称</label>
                ...
                <div class="input-group date" style="position: relative;">
                  ...
                  <input readonly="readonly" name="startdate" id="test" value="" class="txt" style="width:400px;border-color:1px solid #d2d6de" type="text">
      <br />
      <input class="button" style="opacity: 0;position: absolute;top:0px;width: 400px"  type="button" id="selbtn" name="selbtn" value="时间" onclick="showCalendar('test', '%Y-%m-%d %H:%M', '24', false, 'selbtn');" />
                  <!-- <input type="text" name="startdate" class="form-control pull-right" id="datepickerstart"> -->
                </div>
              </div>
              <div class="form-group">
                <label>结束时间:</label>
                <div class="input-group date" style="position: relative;">
                  ...
                  <input readonly="readonly" name="enddate" id="test1" value="" class="txt" style="width:400px;border-color:1px solid #d2d6de" type="text">
      <br />
      <input style="opacity: 0;position: absolute;top:0px;width: 400px" class="button" type="button" id="selbtn1" name="selbtn1" value="时间" onclick="showCalendar('test1', '%Y-%m-%d %H:%M', '24', false, 'selbtn1');" />
                  <!-- <input type="text" name="enddate" class="form-control pull-right" id="datepickerend"> -->
                </div>
              </div>
              <input type="hidden" name="createstaffid" value='<?php echo ($data["stffid"]); ?>'/>
              </form>
                <div class="form-group">
                    <button id="addGradeOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var addGradeOperate = document.getElementById("addGradeOperate");
    addGradeOperate.onclick=function()
    {     
          document.getElementById("addGrade").submit();
    }
  </script>
<script>
  $(function () {
