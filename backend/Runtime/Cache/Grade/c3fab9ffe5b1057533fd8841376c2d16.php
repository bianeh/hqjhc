...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Grade/Index/addgradepage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加档期</button></a>
           <a href="<?php echo U('Grade/Index/index');?>"><button type="button" class="btn bg-purple margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php echo (mb_substr($vo["gradename"],0,10,'utf-8')); ?>...</td>
                  ...
                  <td>
                      <a href="<?php echo U('Grade/Index/editgradepage',['id'=>$vo['id']]);?>">
...
<script>
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      {
         var id = $(this).val();
         window.location.href="<?php echo U('Grade/Index/delete/id/"+id+"');?>";
      }
    });
  })
</script>