...
<!-- Left side column. contains the logo and sidebar -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          供货商反馈信息列表
        <small>供货商反馈信息列表</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 后台</a></li>
        <li><a href="#">供货商反馈管理</a></li>
        <li class="active">供货商反馈管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
        <div class="search1">
...
<script>
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      {
         var id = $(this).val();
         window.location.href="<?php echo U('Offers/Feedback/delete/id/"+id+"');?>";
      }
    });
  })
</script>