            ...
            <div class="box-body">
              <form role="form" id="addOffer" method="post"  action="<?php echo U('Offers/Index/doAddOffers');?>">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label>供货商姓名</label>
                  <input type="text" id="offerName" name="offerName" class="form-control" placeholder="供货商姓名">
                </div>
                <div class="form-group">
                  <label>身份证</label>
                  <input type="text" id="idNo" name="idNo" class="form-control" placeholder="身份证">
                </div>
                 <div class="form-group">
                  <label>手机号码</label>
                 ...
                 <div class="form-group">
                  <label>微信</label>
                  <input type="text" id="wechat" name="wechat" class="form-control" placeholder="微信">
                </div>
               <input type="hidden" name="createstaffid" value="<?php echo ($data["stffid"]); ?>" />
              </form>
                <div class="form-group">
                    <button id="addOfferOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
