...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Offers/Index/index');?>">供货商管理</a></li>
        <li class="active">修改供货商信息</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <!--         <h3 class="box-title">管理员添加</h3> -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editOffer" method="post"  action="<?php echo U('Offers/Index/doEditOffers');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>账号</label>
                  <input type="text" id="loginName" value="<?php echo ($info["loginname"]); ?>" name="loginName" class="form-control" placeholder="账号">
                </div>
                <!-- <div class="form-group">
                  <label>密码</label>
                 ...
                 <div class="form-group">
                  <label>供货商姓名</label>
                  <input type="text" id="offerName" value="<?php echo ($info["offername"]); ?>" name="offerName" class="form-control" placeholder="供货商姓名">
                </div>
                <div class="form-group">
                  <label>身份证</label>
                  <input type="text" id="idNo" name="idNo" value="<?php echo ($info["idno"]); ?>" class="form-control" placeholder="身份证">
                </div>
                 <div class="form-group">
                  <label>手机号码</label>
                  <input type="text" id="mobile" name="mobile" value="<?php echo ($info["mobile"]); ?>" class="form-control" placeholder="手机号码">
                </div>
                 <div class="form-group">
                  <label>邮箱</label>
                  <input type="text" id="email" name="email" value="<?php echo ($info["email"]); ?>" class="form-control" placeholder="邮箱">
                </div>
                 <div class="form-group">
                  <label>微信</label>
                  <input type="text" id="wechat" name="wechat" value="<?php echo ($info["wechat"]); ?>" class="form-control" placeholder="微信">
                </div>
                <input type="hidden" name="updatestaffid" value="<?php echo ($data["staffid"]); ?>" />
                <input type="hidden" name="offerid" value="<?php echo ($info["offerid"]); ?>" />
              </form>
                <div class="form-group">
                    <button id="editOfferOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-edit"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var editOfferOperate = document.getElementById("editOfferOperate");
    editOfferOperate.onclick=function()
    {     
          document.getElementById("editOffer").submit();
