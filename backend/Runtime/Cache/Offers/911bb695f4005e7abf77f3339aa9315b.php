  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">供货商管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Offers/Index/addOffersPage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加供货商</button></a>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["offerid"]); ?></td>
                  <td><?php echo ($vo["loginname"]); ?></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td><?php echo ($vo["lasttime"]); ?></td>
                  <td><?php echo ($vo["lastip"]); ?></td>
                  <td>
                      <a href="<?php echo U('Offers/Index/editofferspage');?>?offerid=<?php echo ($vo["offerid"]); ?>">
                      <button class="btn bg-olive btn-flat margin">
                          <i class="fa fa-fw fa-edit"></i>编辑
                      </button>
                      </a>
                       <a href="<?php echo U('Offers/Index/resetpwdpage');?>?offerid=<?php echo ($vo["offerid"]); ?>">
                      <button class="btn bg-purple margin">
                          <i class="fa fa-fw fa-refresh"></i>重置密码
                      </button>
                      </a>
                      <!-- <a href="<?php echo U('Offers/Index/delete');?>?offerid=<?php echo ($vo["offerid"]); ?>"> -->
                      <button value="<?php echo ($vo["offerid"]); ?>" class="btn bg-maroon btn-flat margin delete">
  ...
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      if(r)
      {
         ...
         window.location.href="<?php echo U('Offers/Index/delete/offerid/"+offerid+"');?>";
      }
    });
  })
</script>