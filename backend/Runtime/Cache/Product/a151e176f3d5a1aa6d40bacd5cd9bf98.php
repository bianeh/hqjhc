...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Product/Brands/index');?>">品牌管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editBrands" method="post" action="<?php echo U('Product/Brands/doEditBrands');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>品牌名称</label>
                  <input type="text"  name="brandName" value="<?php echo ($info["brandname"]); ?>" class="form-control" placeholder="品牌名称">
                </div>
                <div class="form-group">
                  <label>品牌描述</label>
                  <input type="text"  name="brandDesc" value="<?php echo ($info["branddesc"]); ?>" class="form-control" placeholder="品牌描述">
                </div>
                <div class="form-group">
                  <label>品牌排序</label>
                  <input type="text"  name="sort" value="<?php echo ($info["sort"]); ?>" class="form-control" placeholder="品牌排序">
                </div>
                <div class="form-group">
                  <label>品牌logo</label>
                  ...
                  <div style="width:100px;height:80px;background: #dddddd;margin-top:3px">
                      <img id="img1" height="80px" width="100px" <?php if($info['brandlogo'] == ''): ?>src="<?php echo (ROOT_URL); ?>/Public/backend/dist/img/boxed-bg.jpg" <?php else: ?>src="<?php echo (DATA_URL); ?>/<?php echo ($info["brandlogo"]); ?>"<?php endif; ?> />
                  </div>
                  <input type="hidden" name="brandLogo" value="<?php echo ($info["brandlogo"]); ?>"/>
                </div>
              ...
              <div class="form-group">
                  ...
                  <input type="radio" <?php $isShow = $info['isshow'];if($isShow == 0) echo "checked" ?> value='0'  name="isShow"  />是
                  <input type="radio" <?php $isShow = $info['isshow'];if($isShow == 1) echo "checked" ?> value='1'  name="isShow" />否
              </div>
              <input type="hidden" name="updatestaffid" value='<?php echo ($data["stffid"]); ?>'/>
              <input type="hidden" name="brandid" value="<?php echo ($info["brandid"]); ?>" />
              </form>
                <div class="form-group">
                    <button id="editBrandsOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-edit"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var editBrandsOperate = document.getElementById("editBrandsOperate");
    editBrandsOperate.onclick=function()
    {     
          document.getElementById("editBrands").submit();
    }
  </script>
  <script>
      function readyup()
    ...
    function ajaxFileUpload() {
            ...
            (
                    {
                        url: "<?php echo U('Upload/Index/upload');?>", //用于文件上传的服务器端请求地址
