...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Product/Brands/addbrandspage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加品牌</button></a>
           <a href="<?php echo U('Product/Brands/index');?>"><button type="button" class="btn bg-purple margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["brandid"]); ?></td>
                  <td><?php echo (mb_substr($vo["brandname"],0,10,'utf-8')); ?>...</td>
                  <td><img class="normalImg" src="<?php echo (DATA_URL); ?>/<?php echo ($vo["brandlogo"]); ?>" /></td>
                  <td><?php echo (mb_substr($vo["branddesc"],0,10,'utf-8')); ?>...</td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td><?php echo ($vo["createstaffname"]); ?></td>
                  <td><?php echo ($vo["updatetime"]); ?></td>
                  <td><?php echo ($vo["updatestaffname"]); ?></td>
                  <td>
                      <a href="<?php echo U('Product/Brands/editbrandspage',['brandid'=>$vo['brandid']]);?>">
                      <button class="btn bg-olive btn-flat margin">
                          <i class="fa fa-fw fa-edit"></i>编辑
                      </button>
                      </a>
                      <button value="<?php echo ($vo["brandid"]); ?>" class="btn bg-maroon btn-flat margin delete">
  ...
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      if(r)
      {
         ...
         window.location.href="<?php echo U('Product/Brands/delete/brandid/"+brandid+"');?>";
      }
    });
  })
</script>