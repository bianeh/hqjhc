...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Product/goodscats/index');?>">产品分类管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editgoodscats" method="post" action="<?php echo U('Product/Goodscats/doEditGoodscats');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>分类名称</label>
                  <input type="text" id="catName" name="catName" value="<?php echo ($info["catname"]); ?>" class="form-control" placeholder="分类名称">
                </div>

                <div class="form-group">
                  <label>父级分类</label>
                  <select multiple="" id="parentid" name="parentid" class="form-control">
                    <option <?php $parentid = $info['parentid'];if($parentid == 0) echo "selected" ?> value='0'>请选择分类</option>
                    <?php foreach ($goodscatslist as $val){ ?>
                    <option <?php $valid = $val['catid'];$parentid = $info['parentid'];if($parentid == $valid) echo "selected" ?> value="<?php echo $val['catid'] ?>">
                ...
                <div class="form-group">
                  <label>分类描述</label>
                  <textarea name="catDesc"  class="form-control"><?php echo ($info["catdesc"]); ?></textarea>
                </div>
                <input type="hidden" name="updatestaffid" value='<?php echo ($data["stffid"]); ?>' />
                <input type="hidden" name='catid' value="<?php echo ($info["catid"]); ?>" />
              </form>
                <div class="form-group">
                    <button id="editGoodscatsOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-edit"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    ...
    var editGoodscatsOperate = document.getElementById("editGoodscatsOperate");
    editGoodscatsOperate.onclick=function()
    {    
          document.getElementById("editgoodscats").submit();
    }
  </script>