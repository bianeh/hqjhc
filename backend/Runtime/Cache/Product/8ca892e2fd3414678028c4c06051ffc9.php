  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">产品分类管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
    <div class="callout callout-info ">
        管理员可以在此管理所添加的产品分类信息包括编辑、删除操作
      </div>
    </div>
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Product/Goodscats/addgoodscatspage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加产品分类</button></a>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                <?php if(is_array($goodscatslist)): $i = 0; $__LIST__ = $goodscatslist;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><?php echo ($vo["html"]); echo ($vo["catname"]); ?></td>
                  <td><?php echo ($vo["createstaffid"]); ?></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td>
                      <a href="<?php echo U('Product/Goodscats/editgoodscatspage',['catid'=>$vo['catid']]);?>">
                      <button class="">
...
<script>
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      {
         var catid = $(this).val();
         window.location.href="<?php echo U('Product/Goodscats/delete/catid/"+catid+"');?>";
      }
    });
  })
</script>