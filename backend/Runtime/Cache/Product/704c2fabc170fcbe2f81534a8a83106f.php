...
<link rel="stylesheet" href="<?php echo (ROOT_URL); ?>/Public/backend/css/index.css">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Product/Index/index');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-question-sign"></span>待审核商品</button></a>
