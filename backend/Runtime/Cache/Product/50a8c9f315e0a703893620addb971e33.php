    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Product/Index/downproductpage');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-ban-circle"></span>已下架商品</button></a>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                      ...
                      <button value="<?php echo ($vo["id"]); ?>" class="btn bg-purple btn-flat margin upproduct">
                          <i class="fa fa-fw fa-exchange"></i>上架
                      </button>
                      <div class="btn-group">
