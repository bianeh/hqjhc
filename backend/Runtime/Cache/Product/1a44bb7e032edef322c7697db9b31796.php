  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Product/Brands/index');?>">产品管理</a></li>
    ...
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Product/Index/addproductpage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加产品</button></a>
    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Product/Index/acrosspage');?>"><button type="button" class="btn bg-default btn-flat margin"><span class="glyphicon glyphicon-ok-sign"></span>审核通过商品</button></a>
           <a href="<?php echo U('Product/Index/upproductpage');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-shopping-cart"></span>上架商品</button></a>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                      <a href="<?php echo U('Product/Index/editproductpage',['id'=>$vo['id']]);?>">
                      ...
                      <button value="<?php echo ($vo["id"]); ?>" class="btn bg-purple btn-flat margin upproduct">
                          <i class="fa fa-fw fa-exchange"></i>下架
                      </button>
                      <div class="btn-group">
...
<script>
  $(function () {
    ...
    $(".upproduct").click(function(){
       var r = confirm("确定要下架该产品吗");
       var id= $(this).val();
       if(r)
       {
          window.location.href="<?php echo U('Product/Index/downproduct/id/"+id+"');?>";
       }
    })
  })
</script>