...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addgoodscats" method="post" action="<?php echo U('Product/Goodscats/doAddGoodscats');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>分类名称</label>
                  <input type="text" id="catName" name="catName" class="form-control" placeholder="分类名称">
                </div>
                ...
                <div class="form-group">
                    <button id="addGoodscatsOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    ...
    var addGoodscatsOperate = document.getElementById("addGoodscatsOperate");
    addGoodscatsOperate.onclick=function()
    {    
          document.getElementById("addgoodscats").submit();
    }
  </script>