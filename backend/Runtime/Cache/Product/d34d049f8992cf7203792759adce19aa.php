      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addBrands" method="post" action="<?php echo U('Product/Brands/doAddBrands');?>">
                <!-- text input -->
                ...
                <div class="form-group">
                  ...
                  <div style="width:100px;height:80px;background: #dddddd;margin-top:3px">
                      <img id="img1" height="80px" width="100px" src="<?php echo (ROOT_URL); ?>/Public/backend/dist/img/boxed-bg.jpg" />
                  </div>
