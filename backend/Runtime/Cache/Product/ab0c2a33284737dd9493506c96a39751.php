    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Product/Index/failpage');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-remove-sign"></span>审核未通过商品</button></a> 
        </div>
      </div>
        <div class="col-xs-12">
          <div class="box">
