  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Admin/Index/index');?>">管理员管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editUser" method="post" action="<?php echo U('Admin/Index/doEditUser');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>账号</label>
                  <input type="text" id="loginName" name="loginName" value="<?php echo ($info["loginname"]); ?>" class="form-control" placeholder="账号">
                </div>
                <!-- <div class="form-group">
                  <label>密码</label>
                  <input type="text" id="loginPwd" name="loginPwd" value="<?php echo ($info["loginpwd"]); ?>" class="form-control" placeholder="关键字">
                </div> -->
                 <div class="form-group">
                  <label>职员姓名</label>
                  <input type="text" id="staffName" name="staffName" value="<?php echo ($info["staffname"]); ?>" class="form-control" placeholder="职员姓名">
                </div>
                <div class="form-group">
                  <label>职员编号</label>
                  <input type="text" id="staffNo" name="staffNo" value="<?php echo ($info["staffno"]); ?>" class="form-control" placeholder="职员编号">
                </div
                <div class="form-group">
                  <label>头像</label>
                  ...
                  <div style="width:100px;height:80px;background: #dddddd;margin-top:3px">
                      <img id="img1" height="80px" width="100px" src="<?php echo (DATA_URL); ?>/<?php echo ($info["staffphoto"]); ?>" />
                  </div>
                  <input type="hidden" name="staffPhoto" value="<?php echo ($info["staffphoto"]); ?>" />
                </div>
                <div class="form-group">
                  <label>所属部门</label>
                ...
                <input type="hidden" name="stffid" value="<?php echo ($info["stffid"]); ?>" />
