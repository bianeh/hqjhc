  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">部门管理</a></li>
        <li class="active">部门管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Admin/Roles/addRolesPage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加部门</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
        <div class="search">
            ...
            <label>创建时间:</label><input name="createTime" id="datepickerstart" readonly="readonly" type="text" />
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["roleid"]); ?></td>
                  <td><?php echo ($vo["roleName"]); ?></td>
                  <td><?php echo ($vo["roleDesc"]); ?></td>
                  <td><?php echo ($vo["createTime"]); ?></td>
                  <td><?php echo ($vo["createid"]); ?></td>
                  <td><?php echo ($vo["updateTime"]); ?></td>
                  <td><?php echo ($vo["updateid"]); ?></td>
                  <td>
                      <a href="<?php echo U('Admin/Index/edituserpage');?>?stffid=<?php echo ($vo["stffid"]); ?>">
                      <button class="btn bg-olive btn-flat margin">
                          编辑
                      </button>
                      </a>
                      <a href="<?php echo U('Admin/Index/delete');?>?stffid=<?php echo ($vo["stffid"]); ?>">
