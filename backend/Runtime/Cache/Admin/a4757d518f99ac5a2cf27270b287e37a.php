            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["stffid"]); ?></td>
                  <td><?php echo ($vo["loginname"]); ?></td>
                  <td><?php echo ($vo["loginpwd"]); ?></td>
                  <td><?php echo ($vo["staffroleid"]); ?></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td><?php echo ($vo["createstaffname"]); ?></td>
                  <td><?php echo ($vo["lasttime"]); ?></td>
                  <td><?php echo ($vo["lastip"]); ?></td>
                  <td>
                      <a href="<?php echo U('Admin/Index/edituserpage',['stffid'=>$vo['stffid']]);?>">
                      <button class="btn bg-olive btn-flat margin">
                          <i class="fa fa-fw fa-edit"></i>编辑
                      </button>
                      </a>
                      <a href="<?php echo U('Admin/Index/resetpwdpage');?>?stffid=<?php echo ($vo["stffid"]); ?>">
                      <button class="btn bg-purple margin">
                          <i class="fa fa-fw fa-refresh"></i>重置密码
                      </button>
                      </a>
                      <button value="<?php echo ($vo["stffid"]); ?>" class="btn bg-maroon btn-flat margin delete">
