            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["privilegeid"]); ?></td>
                  <td><?php echo ($vo["privilegename"]); ?></td>
                  <td><?php echo ($vo["privilegecode"]); ?></td>
                  <td><?php echo ($vo["privilegedesc"]); ?></td>
