<?php if (!defined('THINK_PATH')) exit();?><link rel="stylesheet" href="<?php echo (ROOT_URL); ?>/Public/backend/css/index.css">
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"> 超级管理员 - Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree" style="color:#fff">
        ...
        <li id="Article" class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo U('Article/Index/index');?>"><i class="fa fa-circle-o"></i>资讯公告列表</a></li>
            <li><a href="<?php echo U('Article/Articlecat/index');?>"><i class="fa fa-circle-o"></i>资讯公告分类</a></li>
        ...
        <li id ="WechatBus" class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo U('Users/Index/index');?>"><i class="fa fa-circle-o"></i>会员列表</a></li>
            <li><a href="<?php echo U('Users/Address/index');?>"><i class="fa fa-circle-o"></i>地址信息管理</a></li>
            <li><a href="javascript:void(0)" onclick="javascript:alert('此模块在开发当中')"><i class="fa fa-circle-o"></i>优惠券管理</a></li>
            <li><a href="javascript:void(0)" onclick="javascript:alert('此模块在开发当中')"><i class="fa fa-circle-o"></i>积分记录</a></li>
            <li><a href="javascript:void(0)" onclick="javascript:alert('此模块在开发当中')"><i class="fa fa-circle-o"></i>会员记录</a></li>
        ...
        <li id="Orders" class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo U('Order/Index/index');?>"><i class="fa fa-circle-o"></i>退款/退货</a></li>
          </ul>
        </li>
        ...
        <li id="Fund" class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="javascript:void(0)" onclick="javascript:alert('此模块在开发当中')"><i class="fa fa-circle-o"></i>微商会员资金流出记录</a></li>
            <li><a href="<?php echo U('Funds/Recharge/index');?>"><i class="fa fa-circle-o"></i>微商会员资金流入记录</a></li>
            <li><a href="<?php echo U('Funds/Userslogsmoneys/getentrance');?>"><i class="fa fa-circle-o"></i>资金流入记录</a></li>
            <li><a href="javascript:void(0)" onclick="javascript:alert('此模块在开发当中')"><i class="fa fa-circle-o"></i>资金流出记录</a></li>
          </ul>
        </li>
         <li id="Message" class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="javascript:void(0)" onclick="javascript:alert('此模块在开发当中')"><i class="fa fa-circle-o"></i>短信管理</a></li>
          </ul>
        </li>
...
<!-- Left side column. contains the logo and sidebar -->
  <div class="content-wrapper">
    ...
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Ticket/Index/addTicketPage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加优惠券</button></a>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["ticketid"]); ?></td>
                  <td><?php echo ($vo["ticketname"]); ?></td>
                  <td>
                      <?php if($vo['tickettype'] == 1): ?>邮费折扣券<?php endif; ?>
                      <?php if($vo['tickettype'] == 2): ?>其他<?php endif; ?>
                  </td>
                  <td><img class="normalImg" src="<?php echo (DATA_URL); ?>/<?php echo ($vo["brandlogo"]); ?>" /></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td><?php echo ($vo["createstaffname"]); ?></td>
                  <td><?php echo ($vo["starttime"]); ?></td>
                  <td><?php echo ($vo["endtime"]); ?></td>
                  <td>
                      <a href="<?php echo U('Ticket/Index/editTicketPage');?>?ticketid=<?php echo ($vo["ticketid"]); ?>">
                      <button class="btn bg-olive btn-flat margin">
                          <i class="fa fa-fw fa-edit"></i>编辑
                      </button>
                      </a>
                      <button value="<?php echo ($vo["ticketid"]); ?>" class="btn bg-maroon btn-flat margin delete">
  ...
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      if(r)
      {
         ...
         window.location.href="<?php echo U('Ticket/Index/delete/ticketid/"+ticketid+"');?>";
      }
    });
  })
</script>