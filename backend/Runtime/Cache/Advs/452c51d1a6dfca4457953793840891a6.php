  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Advs/Index/index');?>">广告管理</a></li>
        <li class="active">广告列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
    <div class="callout callout-info ">
        管理员可以在此管理广告图片信息包括编辑、删除操作
      </div>
    </div>
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Advs/Index/addadvpage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加广告</button></a>
           <a href="<?php echo U('Advs/Index/index');?>"><button type="button" class="btn bg-purple margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
        <div class="search">
            ...
            <label>广告名称:</label><input name="adName" type="text" />
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["adid"]); ?></td>
                  <td><?php echo (mb_substr($vo["adname"],0,10,'utf-8')); ?>...</td>
                  <td><img class="adfile" src="<?php echo (DATA_URL); ?>/<?php echo ($vo["adfile"]); ?>" /></td>
                  <td><?php echo ($vo["adstartdate"]); ?></td>
                  <td><?php echo ($vo["adenddate"]); ?></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td><?php echo ($vo["createstaffname"]); ?></td>
                  <td><?php echo ($vo["updatetime"]); ?></td>
                  <td><?php echo ($vo["updatestaffname"]); ?></td>
                  <td>
                      <a href="<?php echo U('Advs/Index/editadvpage',['adid'=>$vo['adid']]);?>">
                      <button class="btn bg-olive btn-flat margin">
                          <i class="fa fa-fw fa-edit"></i>编辑
                      </button>
                      </a>
                      <button value="<?php echo ($vo["adid"]); ?>" class="btn bg-maroon btn-flat margin delete">
...
<script>
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      {
         var adid = $(this).val();
         window.location.href="<?php echo U('Advs/Index/delete/adid/"+adid+"');?>";
      }
    });
  })
</script>