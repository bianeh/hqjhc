  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Grade/Index/index');?>">系统广告管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editAdv" method="post" action="<?php echo U('Advs/Index/doEditadv');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>广告名称</label>
                  <input type="text"  name="adName" value="<?php echo ($info["adname"]); ?>" class="form-control" placeholder="广告名称">
                </div>
                <div class="form-group">
                  <label>广告URL</label>
                  <input type="text"  name="adUrl" value="<?php echo ($info["adurl"]); ?>" class="form-control" placeholder="广告URL">
                </div>
                 <div class="form-group">
                  <label>广告图片</label>
                  ...
                  <div style="width:100px;height:80px;background: #dddddd;margin-top:3px"> 
                      <img id="img1" height="80px" width="100px" <?php if($info['adfile'] == ''): ?>src="<?php echo (ROOT_URL); ?>/Public/backend/dist/img/boxed-bg.jpg" <?php else: ?>src ="<?php echo (DATA_URL); ?>/<?php echo ($info["adfile"]); ?>"<?php endif; ?> />
                  </div>
                  <input type="hidden" name="adFile" value="<?php echo ($info["adfile"]); ?>"/>
                </div>
                <div class="form-group">
                  <label>排序</label>
                  <input type="text"  name="adsort" value="<?php echo ($info["adsort"]); ?>" class="form-control" placeholder="排序">
                </div>
                <div class="form-group">
                  <label>广告位置</label>
                  <select multiple="" name="adpositionid" class="form-control">
                    <option value=''>请选择</option>
                    <option <?php if($info['adpositionid'] == 1): ?>selected <?php else: endif; ?> value='1'>微商端首页轮播广告</option>
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="adstartDate" value="<?php echo ($info["adstartdate"]); ?>" class="form-control pull-right" id="datepickerstart">
                </div>
              </div>
              <div class="form-group">
                <label>结束时间:</label>
                <div class="input-group date">
                  ...
                  <input type="text" name="adendDate" value="<?php echo ($info["adenddate"]); ?>" class="form-control pull-right" id="datepickerend">
                </div>
              </div>
              <input type="hidden" name="updatestaffid" value='<?php echo ($data["stffid"]); ?>'/>
              <input type="hidden" name="adid" value="<?php echo ($info["adid"]); ?>"/>
              </form>
                <div class="form-group">
