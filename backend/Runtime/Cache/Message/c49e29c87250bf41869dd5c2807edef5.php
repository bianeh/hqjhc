...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Message/Index/index');?>">消息管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editMessage" method="post" action="<?php echo U('Message/Index/doEditMessage');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>消息标题</label>
                  <input type="text" value="<?php echo ($info["messagetitle"]); ?>" id="messageTitle" name="messageTitle" class="form-control" placeholder="标题">
                </div>
                <div class="form-group">
                  <label>消息类型</label>
                  <select multiple="" name="messageType" class="form-control">
                     <option <?php if($info['messagetype'] == 1): ?>selected<?php endif; ?> value='1'>预告消息</option>
                     <option <?php if($info['messagetype'] == 2): ?>selected<?php endif; ?>  value='2'>公告消息</option>
                     <option <?php if($info['messagetype'] == 3): ?>selected<?php endif; ?> value='3'>活动消息</option>
                  </select>
                </div>
                <div class="form-group">
                  <label>消息内容</label>
                  <textarea class="form-control" name="messageContent"><?php echo ($info["messagecontent"]); ?></textarea>
                </div>
              <input type="hidden" value="<?php echo ($info["messageid"]); ?>" name="messageid" />
              <input type="hidden" value='<?php echo ($data["stffid"]); ?>' name="updatestaffid"/>
              </form>
                <div class="form-group">
                    <button id="editMessageOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-edit"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    ...
    var editMessageOperate = document.getElementById("editMessageOperate");
    editMessageOperate.onclick=function()
    {     
          document.getElementById("editMessage").submit();
    }
  </script>