...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addMessage" method="post" action="<?php echo U('Message/Index/doAddMessage');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>消息标题</label>
                  <input type="text" id="messageTitle" name="messageTitle" class="form-control" placeholder="标题">
                </div>
                <div class="form-group">
                  <label>消息类型</label>
                  <select multiple="" name="messageType" class="form-control">
                     <option selected value='0'>请选择</option>
                     <option value='1'>预告消息</option>
              ...
              <input type="hidden" name="createstaffid" value='<?php echo ($data["stffid"]); ?>'/>
                ...
                <div class="form-group">
                    <button id="addMessageOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    ...
    var addMessageOperate = document.getElementById("addMessageOperate");
    addMessageOperate.onclick=function()
    {     
