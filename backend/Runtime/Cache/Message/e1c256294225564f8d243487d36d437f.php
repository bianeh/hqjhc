...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Message/Webnotify/index');?>">站内信管理</a></li>
        <li class="active">添加站内信</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addWebnotify" method="post" action="<?php echo U('Message/Webnotify/doAddWebnotify');?>">
                <!-- text input -->
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <select multiple="" name="messageType" class="form-control">
                     ...
                     <option value='1' selected>全部发送</option>
                  </select>
                </div> 
                <div class="form-group">
                  <label>站内信内容</label>
              ...
              <input type="hidden" name="createstaffid" value='<?php echo ($data["stffid"]); ?>'/>
                ...
                <div class="form-group">
                    <button id="addWebnotifyOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    ...
    var addWebnotifyOperate = document.getElementById("addWebnotifyOperate");
    addWebnotifyOperate.onclick=function()
    {     
          document.getElementById("addWebnotify").submit();
    }
  </script>