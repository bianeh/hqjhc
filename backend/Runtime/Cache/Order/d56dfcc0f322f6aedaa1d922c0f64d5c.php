...
<link rel="stylesheet" href="<?php echo (ROOT_URL); ?>/Public/backend/css/index.css">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Order/Index/index');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-question-sign"></span>全部</button></a>
...
<!--                <tr>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                  <?php if($vo['orderstatus'] == 0): ?>待支付<?php endif; ?>
                  <?php if($vo['orderstatus'] == 1): ?>待发货<?php endif; ?>
                  <?php if($vo['orderstatus'] == 2): ?>拣货中<?php endif; ?>
                  <?php if($vo['orderstatus'] == 3): ?>已发货<?php endif; ?>
                  <?php if($vo['orderstatus'] == 4): ?>已取消<?php endif; ?>
