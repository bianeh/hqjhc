    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Order/Index/paymenting');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-ok-sign"></span>待支付</button></a>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td>
                  <input type="checkbox"/><?php echo ($vo["orderid"]); ?></td>
                  ...
                  <td> 
                      <button value="<?php echo ($vo["orderno"]); ?>" class="btn bg-maroon btn-flat margin cancelaction">
                          <i class="fa fa-fw fa-trash-o"></i>取消订单
                      </button>
