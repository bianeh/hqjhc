    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Order/Index/expressedorder');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-check"></span>已发货</button></a> 
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td> 
                      ...
                      <a target="_blank" href="http://118.31.45.231/api.php/Home/Queryexpress/queryexpress?expressname=<?php echo ($vo["expressname"]); ?>&expressno=<?php echo ($vo["expressno"]); ?>">
                      <button class="btn bg-olive btn-flat margin">
