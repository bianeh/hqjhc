...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Orders/Index/index');?>">订单管理</a></li>
    ...
    <section class="content">
      ...
      <!--         <h3 class="box-title">管理员添加</h3> -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addOffer" method="post"  action="<?php echo U('Offers/Index/doAddOffers');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>订单号</label>
                  <input type="text" id="loginName" name="loginName" readonly="readonly" value="<?php echo ($orderinfo["orderno"]); ?>" class="form-control" placeholder="订单号">
                </div>
                <div class="form-group">
                  <label>产品名称</label>
                  <input type="text" id="loginPwd" name="loginPwd" readonly="readonly"  value="<?php echo ($orderinfo["name"]); ?>" class="form-control" placeholder="产品名称">
                </div>
                 <div class="form-group">
                  <label>产品规格一</label>
                  <input type="text" id="offerName" name="offerName" readonly="readonly" value="<?php echo ($orderinfo["spec1"]); ?>" class="form-control" placeholder="产品规格一">
                </div>
                <div class="form-group">
                  <label>产品规格二</label>
                  <input type="text" id="idNo" name="idNo" readonly="readonly" value="<?php echo ($orderinfo["spec2"]); ?>" class="form-control" placeholder="产品规格二">
                </div>
                 <div class="form-group">
                  <label>购买数量</label>
                  <input type="text" id="mobile" name="mobile" readonly="readonly" value="<?php echo ($orderinfo["num"]); ?>" class="form-control" placeholder="购买数量">
                </div>
                 <div class="form-group">
                  <label>价格</label>
                  <input type="text" id="email" name="email" readonly="readonly" value="<?php echo ($orderinfo["goods_price"]); ?>" class="form-control" placeholder="价格">
                </div>
                 <div class="form-group">
                  <label>用户姓名</label>
                  <input type="text" id="wechat" name="wechat" readonly="readonly" value="<?php echo ($orderinfo["username"]); ?>" class="form-control" placeholder="">
                </div>
                 <div class="form-group">
                  <label>联系方式</label>
                  <input type="text" id="wechat" name="wechat" readonly="readonly" value="<?php echo ($orderinfo["userphone"]); ?>" class="form-control" placeholder="">
                </div>
                <div class="form-group">
                  <label>地址信息</label>
                  <input type="text" id="wechat" name="wechat" readonly="readonly" value="<?php echo ($orderinfo["province"]); ?>(<?php echo ($orderinfo["city"]); echo ($orderinfo["xian"]); echo ($orderinfo["useraddress"]); ?>)" class="form-control" placeholder="">
                </div>
                <div class="form-group">
                  <label>订单备注</label>
                  <textarea readonly="readonly" class="form-control"><?php echo ($orderinfo["remarks"]); ?></textarea>
                </div>
 ...
 <script>
    var addOfferOperate = document.getElementById("addOfferOperate");
    addOfferOperate.onclick=function()
    {     
          document.getElementById("addOffer").submit();
