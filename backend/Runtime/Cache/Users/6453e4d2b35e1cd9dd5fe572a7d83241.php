...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Users/Vipset/index');?>">微商会员购买管理</a></li>
        <li class="active">编辑微商会员购买设置信息</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editvipset" method="post"  action="<?php echo U('Users/Vipset/doeditvipset');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>名称标题</label>
                  <input type="text" id="name" name="name" value="<?php echo ($vipsetinfo["name"]); ?>" class="form-control" placeholder="名称">
                </div>
                <div class="form-group">
                  <label>价格</label>
                  <input type="text" id="price" name="price" value="<?php echo ($vipsetinfo["price"]); ?>" class="form-control" placeholder="价格">
                </div>
                
                <div class="form-group">
                  <label>会员等级</label>
                  <select multiple="" name="level" class="form-control">
                      <option <?php if($vipsetinfo["level"] == 1): ?>selected<?php endif; ?> value="1">1级</option>
                      <option <?php if($vipsetinfo["level"] == 2): ?>selected<?php endif; ?> value="2">2级</option>
                      <option <?php if($vipsetinfo["level"] == 3): ?>selected<?php endif; ?> value="3">3级</option>
                  </select>
                </div>
                  <div class="form-group">
                  <label>描述</label>
                  <textarea name="desc" class="form-control"><?php echo ($vipsetinfo["desc"]); ?></textarea>
                </div>
                <input type="hidden" value="<?php echo ($vipsetinfo["id"]); ?>" name="id" />
              </form>
                <div class="form-group">
                    <button id="editvipsetOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var editvipsetOperate = document.getElementById("editvipsetOperate");
    editvipsetOperate.onclick=function()
    {     
          ...
          {      
              if(price_val != '')
              {
                  document.getElementById("editvipset").submit();
              }else
              {
                  alert('请填写微商会员购买价格！');
              }
