...
<!-- Left side column. contains the logo and sidebar -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          微商地址列表
        <small>微商地址信息列表</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 后台</a></li>
        <li><a href="#">微商地址管理</a></li>
        <li class="active">微商地址管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
        <div class="search1">
<!--           <a href="<?php echo U('Users/Index/addUserPage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加微商地址</button></a>-->
...
<!--                  <th>操作</th>-->
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["addressid"]); ?></td>
                  ...
                  <td>
                    <?php if($vo['isdefault'] == 1): ?>默认收货地址<?php endif; ?>
                    <?php if($vo['isdefault'] == 0): ?>非默认收货地址<?php endif; ?>
...
<!--                  <td>
                      ...
                      <?php if($vo["userstatus"] == 1): ?><button value="<?php echo ($vo["userid"]); ?>" type="button" class="btn btn-info btn-flat menu undozen">
                           <i class="fa fa-fw fa-check-circle"></i>启用
                      </button><?php endif; ?>
                  </td>-->
