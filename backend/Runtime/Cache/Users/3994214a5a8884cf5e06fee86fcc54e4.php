...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">添加微商会员购买设置信息</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addvipset" method="post"  action="<?php echo U('Users/Vipset/dovipset');?>">
                <!-- text input -->
               ...
               <input type="hidden" name="createstaffid" value="<?php echo ($data["stffid"]); ?>" />
                ...
                <div class="form-group">
                    <button id="addvipsetOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var addvipsetOperate = document.getElementById("addvipsetOperate");
    addvipsetOperate.onclick=function()
    {     
          ...
          {      
              if(price_val != '')
              {
                  document.getElementById("addvipset").submit();
              }else
              {
                  alert('请填写微商会员购买价格！');
              }
