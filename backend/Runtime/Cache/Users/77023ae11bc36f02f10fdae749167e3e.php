...
<!-- Left side column. contains the logo and sidebar -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          会员购买设置
        <small>微商会员购买设置</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 后台</a></li>
        <li><a href="#">微商会员购买设置</a></li>
        <li class="active">微商购买设置列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Users/Vipset/vipsetpage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加vip购买信息</button></a>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                      <a href="<?php echo U('Users/Vipset/editvipsetpage');?>?id=<?php echo ($vo["id"]); ?>">
