...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Users/Index/index');?>">微商用户管理</a></li>
        <li class="active">修改微商用户信息</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <!--<h3 class="box-title">管理员添加</h3> -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="resetpwd" method="post"  action="<?php echo U('Users/Index/doResetPwd');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>账号</label>
                  <input type="text" readonly="readonly" id="loginName" value="<?php echo ($info["loginname"]); ?>" name="loginName" class="form-control" placeholder="账号">
                </div>
                <div class="form-group">
                  <label>密码</label>
                ...
                <div class="form-group">
                    <button id="resetPwdOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-edit"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var resetPwdOperate = document.getElementById("resetPwdOperate");
    resetPwdOperate.onclick=function()
    {     
