  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!--         <h3 class="box-title">管理员添加</h3> -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="editUser" method="post"  action="<?php echo U('Users/Index/doEditUser');?>">
                <!-- text input -->
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label>供货商姓名</label>
                  <input type="text" id="userName" value="<?php echo ($info["username"]); ?>" name="offerName" class="form-control" placeholder="供货商姓名">
                </div>
                <div class="form-group">
                  <label>身份证</label>
                 ...
                 <div class="form-group">
                  <label>手机号码</label>
                  <input type="text" id="userphone" name="userphone" value="<?php echo ($info["userphone"]); ?>" class="form-control" placeholder="手机号码">
                </div>
                 <div class="form-group">
                  <label>邮箱</label>
                  <input type="text" id="useremail" name="useremail" value="<?php echo ($info["useremail"]); ?>" class="form-control" placeholder="邮箱">
                </div>
                 <div class="form-group">
                  <label>微信</label>
                ...
                <div class="form-group">
                  <label>账户可用余额</label>
                  <input type="text" id="usermoney" name="usermoney" value="<?php echo ($info["usermoney"]); ?>" class="form-control" placeholder="可用余额">
                </div>
                 <div class="form-group">
                  <label>账户冻结余额</label>
                  <input type="text" id="lockMoney" name="lockMoney" value="<?php echo ($info["lockmoney"]); ?>" class="form-control" placeholder="账户冻结余额">
                </div>
