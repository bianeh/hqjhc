  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Users/Index/index');?>">微商会员管理</a></li>
        <li class="active">添加微商会员</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <!--<h3 class="box-title">管理员添加</h3> -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addUser" method="post"  action="<?php echo U('Users/Index/doAddUser');?>">
                <!-- text input -->
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label>微商姓名</label>
                  <input type="text" id="userName" name="userName" class="form-control" placeholder="微商姓名">
                </div>
                <div class="form-group">
                  <label>身份证</label>
                 ...
                 <div class="form-group">
                  <label>手机号码</label>
                  <input type="text" id="userphone" name="userphone" class="form-control" placeholder="手机号码">
                </div>
                 <div class="form-group">
                  <label>邮箱</label>
