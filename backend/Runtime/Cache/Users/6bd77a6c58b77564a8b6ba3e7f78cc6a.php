  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">微商管理</a></li>
        <li class="active">微商管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Users/Index/addUserPage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加微商用户</button></a>
<!--           <a href="<?php echo U('Recharge/Index/doRecharge');?>"><button type="button" class="btn btn-info btn-flat margin"><i class="fa fa-fw fa-plus"></i>手动充值</button></a>-->
    ...
    <div class="col-xs-12">
        <div class="search">
            ...
            <label>账户号:</label><input name="loginName" type="text" />
            <label>别称:</label><input name="nickname" type="text" />
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><input type="checkbox"/><?php echo ($vo["userid"]); ?></td>
                  <td><?php echo ($vo["loginname"]); ?></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td><?php echo ($vo["lasttime"]); ?></td>
                  <td><?php echo ($vo["lastip"]); ?></td>
                  <td><?php echo ($vo["usermoney"]); ?></td>
                  <td><?php echo ($vo["lockmoney"]); ?></td>
                  <td>
                    <?php if($vo["userstatus"] == 0): ?>正常
                    <?php else: ?>
                       冻结<?php endif; ?>
                  </td>
                  <td>
                        <?php if($vo["vip"] == 1): ?>是<?php endif; ?>
                        <?php if($vo["vip"] == 0): ?>否<?php endif; ?>
                  </td>
                  <td>
                      <a href="<?php echo U('Users/Index/edituserspage');?>?userid=<?php echo ($vo["userid"]); ?>">
                      <button class="btn bg-olive btn-flat margin">
                          <i class="fa fa-fw fa-edit"></i>编辑
                      </button>
                      </a>
                      <!--<a href="<?php echo U('Users/Index/resetpwdpage');?>?userid=<?php echo ($vo["userid"]); ?>">
                      <button class="btn bg-purple margin">
                          <i class="fa fa-fw fa-refresh"></i>重置密码
                      </button>
                      </a>-->
                      <button value="<?php echo ($vo["userid"]); ?>" class="btn bg-maroon btn-flat margin delete">
                          <i class="fa fa-fw fa-trash-o"></i>删除
                      </button>
                      <?php if($vo["userstatus"] == 0): ?><button value="<?php echo ($vo["userid"]); ?>" type="button" class="btn btn-info btn-flat menu dozen">
                           <i class="fa fa-fw fa-check-circle"></i>冻结
                      </button><?php endif; ?>
                      <?php if($vo["userstatus"] == 1): ?><button value="<?php echo ($vo["userid"]); ?>" type="button" class="btn btn-info btn-flat menu undozen">
                           <i class="fa fa-fw fa-gavel"></i>启用
                      </button><?php endif; ?>
                      <a href="<?php echo U('Users/Index/setvippage');?>?userid=<?php echo ($vo["userid"]); ?>">
                      <button  class="btn btn-danger btn-flat margin">
                          <i class="fa fa-fw fa-check-circle"></i>设置vip
                      </button>
                      </a>
                  </td>
...
<script>
  $(function () {
    ...
    $(".delete").click(function(){
      ...
      {
         var userid = $(this).val();
         window.location.href="<?php echo U('Users/Index/delete/userid/"+userid+"');?>";
      }
    });
     $(".setvip").click(function(){
      var r = confirm("该用户是否已经购买过VIP,确定要设置VIP吗！");
      if(r)
      {
         var userid = $(this).val();
         window.location.href="<?php echo U('Users/Index/setvip/userid/"+userid+"');?>";
      }
    });
    $(".dozen").click(function(){
      var r = confirm("确定要冻结该用户吗！");
      if(r)
      {
         var userid = $(this).val();
         window.location.href="<?php echo U('Users/Index/dozen/userid/"+userid+"');?>";
      }
    });
     $(".undozen").click(function(){
      var r = confirm("确定要启用该用户吗！");
      if(r)
      {
         var userid = $(this).val();
         window.location.href="<?php echo U('Users/Index/undozen/userid/"+userid+"');?>";
      }
    });
  })
</script>