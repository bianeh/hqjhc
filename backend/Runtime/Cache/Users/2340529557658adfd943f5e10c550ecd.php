  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Users/Index/index');?>">设置VIP等级</a></li>
        <li class="active">设置VIP</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="setVip" method="post" action="<?php echo U('Users/Index/setvip');?>">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select multiple="" name="level" class="form-control">
                           <option value="1" selected>vip1</option>
...
<!--              <input type="hidden" name="createstaffid" value='<?php echo ($data["stffid"]); ?>'/>-->
                ...
                <div class="form-group">
                    <button id="setVipOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>设置VIP</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var setVipOperate = document.getElementById("setVipOperate");
    setVipOperate.onclick=function()
    {     
          document.getElementById("setVip").submit();
    }
  </script>
<script>
  $(function () {
