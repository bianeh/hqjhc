    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        <div class="search1">
           ...
           <a href="<?php echo U('Orderaf/Index/leakgoods');?>"><button type="button" class="btn bg-default btn-flat margin"><span class="glyphicon glyphicon-zoom-out"></span>漏货</button></a>
           <a href="<?php echo U('Orderaf/Index/lackgoods');?>"><button type="button" class="btn bg-purple btn-flat margin"><span class="glyphicon glyphicon-minus-sign"></span>缺货</button></a>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <?php if($vo['type'] == 2): if($vo['lack_status'] == 0): ?>待处理<?php endif; ?>
                      ...
                      <?php if($vo['lack_status'] == 2): ?>未通过<?php endif; ?>
                       <?php if($vo['lack_status'] == 3): ?>已处理<?php endif; ?>
                      <?php if($vo['lack_status'] == 4): ?>已关闭<?php endif; endif; ?>
                   ...
                   <td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo U('Orderaf/Index/checklackgoodssuccess',['id'=>$vo['id']]);?>">审核通过</a></li>
                        <li><a href="<?php echo U('Orderaf/Index/checklackgoodsfail',['id'=>$vo['id']]);?>">审核不通过</a></li>
                        <li><a href="<?php echo U('Orderaf/Index/lackgoodsdeal',['id'=>$vo['id']]);?>">已处理</a></li>
                        <li><a href="<?php echo U('Orderaf/Index/lackapplyclose',['id'=>$vo['id']]);?>">关闭</a></li>
                      </ul>
                      </div>
                  </td>
<!--                  <td>
