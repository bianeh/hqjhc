  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Article/Index/index');?>">文章管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="updateArticle" method="post" action="<?php echo U('Article/Index/doUpdateArticle');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>标题</label>
                  <input type="text"  value="<?php echo ($info["articletitle"]); ?>" name="articleTitle" class="form-control" placeholder="标题">
                </div>
                <div class="form-group">
                  <label>关键字</label>
                  <input type="text"  value="<?php echo ($info["articlekey"]); ?>" name="articleKey" class="form-control" placeholder="关键字">
                </div>
                 <div class="form-group">
                  <label>来源</label>
                  <input type="text"  value="<?php echo ($info["articlesource"]); ?>" name="articleSource" class="form-control" placeholder="来源">
                </div>
                <div class="form-group">
                  <label>缩略图</label>
                  ...
                  <div style="width:100px;height:80px;background: #dddddd;margin-top:3px">
                      <img id="img1" height="80px" width="100px" <?php if($info['articleimg'] == ''): ?>src="<?php echo (ROOT_URL); ?>/Public/backend/dist/img/boxed-bg.jpg" <?php else: ?>src="<?php echo (DATA_URL); ?>/<?php echo ($info["articleimg"]); ?>"<?php endif; ?>   />
                  </div>
                  <input type="hidden" name="articleImg" value="<?php echo ($info["articleimg"]); ?>"/>
                </div>
                <div class="form-group">
                  <label>文章分类</label>
                 ...
                 <div class="form-group">
                  <label>文章内容</label>
                  <script id="editor" name="articleContent" type="text/plain" style="width:100%;height:500px;"> <div><?php echo (htmlspecialchars_decode($info["articlecontent"])); ?> </div></script>
                </div>
