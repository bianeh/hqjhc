...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Article/Recycle/index');?>"><button type="button" class="btn bg-purple btn-flat margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <div class="col-xs-12">
        <div class="search">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                      <button value="<?php echo ($vo["articleid"]); ?>" class="btn bg-olive btn-flat margin unrecycle">
...
<script>
  $(function () {
    ...
    $(".unrecycle").click(function(){
      ...
      {
         var articleid = $(this).val();
         window.location.href="<?php echo U('Article/Recycle/unrecycle/articleid/"+articleid+"');?>";
      }
    });
