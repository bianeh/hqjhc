  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">文章分类管理列表</li>
      </ol>
    </section>
    <div class="col-xs-12">
    <div class="callout callout-info ">
        管理员可以在此管理所添加的文章分类信息包括编辑、删除操作
      </div>
    </div>
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Article/Articlecat/addarticlecatpage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加文章分类</button></a>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php if(is_array($articlecatslist)): $i = 0; $__LIST__ = $articlecatslist;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><?php echo ($vo["html"]); echo ($vo["catname"]); ?></td>
                  <td><?php echo ($vo["isshow"]); ?></td>
                  <td><?php echo ($vo["createstaffid"]); ?></td>
                  <td><?php echo ($vo["createtime"]); ?></td>
                  <td>
                      <a href="<?php echo U('Article/Articlecat/editarticlecatpage',['catid'=>$vo['catid']]);?>">
                      <button class="">
                          <i class="fa fa-fw fa-edit"></i>编辑
                      </button>
                      </a>
                      <button value="<?php echo ($vo["catid"]); ?>" class="delete">
...
<script type="text/javascript">
    $(document).ready(function(){
        $(".delete").click(function(){
            ...
            if(r)
            {
               window.location.href="<?php echo U('Article/Articlecat/delete/catid/"+catid+"');?>";
            }
        })
    })
</script>