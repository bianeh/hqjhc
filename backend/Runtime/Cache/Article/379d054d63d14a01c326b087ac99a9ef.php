...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Article/Articlecat/index');?>">文章分类管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="EditArticlecat" method="post" action="<?php echo U('Article/Articlecat/doEditArticlecat');?>">
                <!-- text input -->
                <div class="form-group">
                  <label>分类名称</label>
                  <input type="text" id="catName" name="catName" value="<?php echo ($data["catname"]); ?>" class="form-control" placeholder="分类名称">
                </div>
                <div class="form-group">
                  <label>父级分类</label>
                  <select multiple="" name="parentid" class="form-control">
                    <option <?php $parentid = $data['parentid'];if($parentid == 0) echo "selected" ?> value='0'>请选择分类</option>
                    <?php foreach ($articlecatslist as $val){ ?>
                    <option <?php $valid = $val['catid'];$parentid = $data['parentid'];if($parentid == $valid) echo "selected" ?> value="<?php echo $val['catid'] ?>">
                ...
                <div class="form-group">
                  <label>分类描述</label>
                  <textarea name="catDesc"  class="form-control"><?php echo ($data["catdesc"]); ?></textarea>
                </div>
                <div class="form-group">
                    <label>
                  是否显示
                ...
                <div class="form-group">
                    <button id="EditArticlecatOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-edit"></i>编辑</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    var EditArticlecatOperate = document.getElementById("EditArticlecatOperate");
    EditArticlecatOperate.onclick=function()
    {     
          document.getElementById("EditArticlecat").submit();
      }
  </script>