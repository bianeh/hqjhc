...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="addArticlecat" method="post" action="<?php echo U('Article/Articlecat/doAddArticlecat');?>">
                <!-- text input -->
                ...
                <div class="form-group">
                    <button id="addArticlecatOperate" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加</button>
                </div>
            </div>
            <!-- /.box-body -->
          </div>
 ...
 <script>
    ...
    var addArticlecatOperate = document.getElementById("addArticlecatOperate");
    addArticlecatOperate.onclick=function()
    {    
          document.getElementById("addArticlecat").submit();
    }
  </script>