...
<script src="<?php echo (ROOT_URL); ?>/Public/backend/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-xs-12">
        <div class="search1">
           <a href="<?php echo U('Article/Index/addArticlepage');?>"><button type="button" class="btn bg-olive btn-flat margin"><i class="fa fa-fw fa-plus"></i>添加文章</button></a>
           <a href="<?php echo U('Article/Index/index');?>"><button type="button" class="btn bg-purple btn-flat margin"><i class="fa fa-fw fa-refresh"></i>刷新页面</button></a>
        </div>
    </div>
    <!-- Search content end -->
    <div class="col-xs-12">
        <div class="search">
            <form id="search" action="<?php echo U('Article/Index/index');?>" method="get" >
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><img class="articleimg" src="<?php echo (DATA_URL); ?>/<?php echo ($vo["articleimg"]); ?>" /></td>
                  ...
                  <td>
                      <a href="<?php echo U('Article/Index/editArticlepage',array('articleid'=>$vo['articleid']));?>">
